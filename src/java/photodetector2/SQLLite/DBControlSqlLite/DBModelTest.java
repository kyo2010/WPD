 ...
 */
package photodetector2.SQLLite.DBControlSqlLite;

import photodetector2.SQLLite.Utils.UserException;
import photodetector2.SQLLite.DBControlSqlLite.DBFieldAdapters.JDEDateAndTime;
...
import photodetector2.SQLLite.Utils.TempFileWrite;
...
public class DBModelTest {
  ...
  public static final String DATABASE = "photodetector.s3db";
  ...
  public static Connection getConnection(String path) throws UserException{
    try{      
      DriverManager.registerDriver(new JDBC());
      File f = new File("");
      String jdbc_connect_st = "jdbc:sqlite:"+path+"/"+DATABASE;
  ...
  public static void generateClazz(Connection con, String tableName, String className, String path) throws UserException {
    ...
    try{
      ...
      */
      ...
      String package_name = path.replaceAll("src\\\\java\\\\", ""); 
      package_name = package_name.replaceAll("src\\\\", ""); 
      
      package_name = package_name.replaceAll("\\\\", ".");          
      while (package_name.charAt(0)=='.'){
        package_name = package_name.substring(1);
      }
      
      clazz.delete();
      clazz.println("/*** Class Generator V.0.1, This class is based on '"+tableName+"' table.");
      clazz.println(" *** The class was generated automatically.  ***/");
      clazz.println("");
      clazz.println("package "+package_name+";");
      clazz.println("");
      clazz.println("import photodetector2.SQLLite.DBControlSqlLite.*;");
      if (showJDEDate) clazz.println("import  photodetector2.SQLLite.JDEDate;");
      if (showJDEDateAndTime) clazz.println("import  photodetector2.SQLLite.DBControlSqlLite.DBFieldAdapters.JDEDateAndTime;");
